...
namespace ParkeringsApp
{
    internal class Program
    {
        ...
        public static void CreateAccount()
        {
            ...
            string address = GetValidatedInput("Enter Address: ", false);
            string phoneNumber = GetValidatedInput("Enter Phone Number: ", false);
        ...
        static void AddNewCar(User loggedInUser)
        {
            ...
            using (var ourDatabase = new ParkingAppDbContext())
            {
                ourDatabase.Cars.Add(newCar);
                ourDatabase.SaveChanges();
            }
            Console.WriteLine("Car have been added sucessfully!");
        ...
        static void ShowMainMenu(User loggedInUser)
        {
            ...
            while (isRunning)
            {
                ...
                Console.WriteLine("0. Register car");
        ...
        public static void ManageActiveParking(ParkingAppDbContext OurDatabase, int loggedinUserId)
        {
            ...
            Console.Write("\nSelect a parking session to manage (enter the number): ");
